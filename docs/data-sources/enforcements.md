...
- `account` (Attributes) Account-related enforcements (see [below for nested schema](#nestedatt--account))
...
- `two_factor_authentication` (Attributes) 2FA enforcements (see [below for nested schema](#nestedatt--two_factor_authentication))
...
<a id="nestedatt--two_factor_authentication"></a>
### Nested Schema for `two_factor_authentication`
