...
- `restrict_ip_addresses` (String) Restrict IP addresses
- `restrict_vault_ip_addresses` (String) Restrict vault-access from IP addresses
- `tip_zone_restrict_allowed_ip_ranges` (String) Restrict allowed IP ranges for tip zone
